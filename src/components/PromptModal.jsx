...
export default function PromptModal({
  ...
  return (
    <div className="prompt-modal fixed inset-0 z-50 flex items-center justify-center bg-slate-950/80 px-4 py-6 backdrop-blur">
      <div className="prompt-modal__panel w-full max-w-md rounded-[28px] border border-slate-800 bg-slate-900/90 p-6 text-slate-100 shadow-[0_24px_70px_rgba(15,23,42,0.7)]">
